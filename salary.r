...
salary_test <- read.csv("C:/Users/abc/Desktop/Data science/Dataset/Naive Bayes/SalaryData_Test.csv") #This data is used to Test the Model
attach(salary_test)
...
#Here there are many variables that we need to convert into an Categorical Variable. Lets Convert them
...
ggplot(salary_train) + geom_histogram(aes(race), stat = "count") #Instance of White People is more than the Other Race people
